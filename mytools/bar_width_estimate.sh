...
# yet, another line equation to compensate for bigger fonts, when the line equation starts to lose accuracy
#font	compensation
#11	0
#18	80
#y-y0=m(x-x0)
#80-0=m(18-11) --> m=80/7 --> m=11.42857
#y=mx+b --> 80=11.42857*18 + b --> b=-125.7416
#
...
echo "(($m * $font + $b + $comp) * $chars + $seps +    11.42857*$font - 125.7416 ) / 1" | bc
